...
```{r fig15, out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig16, out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
